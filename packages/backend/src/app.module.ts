...
import { VaultService } from './services/wallets/fireblocks/vault.service';
import { FireblocksVaultController } from './controller/wallets/fireblocks/vault.controller';

@Module({
  imports: [ConfigModule.forRoot(), HttpModule],
  controllers: [
    //Fireblocks
    FireblocksTxnController,
    FireblocksAccountController,
    FireblocksWalletController,
  ...
  providers: [
    //Fireblocks
    FireblocksAccountService,
    FireblocksTxnService,
    FireblocksWalletService,
    VaultService,
